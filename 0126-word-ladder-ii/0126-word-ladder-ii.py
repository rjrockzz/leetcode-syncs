...
class Solution:
    ...
    def getWordTree(self,
        ...
        while q and not found:
            ...
            visited_tree.update(visited_this_level) # basically updated the sets globally, this is a comment by me!
...
x = Solution()
print(x.findLadders(beginWord = "hit", endWord = "cog", wordList = ["hot","dot","dog","lot","log","cog"]))